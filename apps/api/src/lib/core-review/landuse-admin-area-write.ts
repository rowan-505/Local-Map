...
/** Landuse create — infer township from polygon when admin_area_id is omitted. */
export async function applyLanduseAdminAreaForCreate(
...
/**
 * Landuse update — omitted admin_area_id preserves township/null and clears legacy non-township.
 */
export async function applyLanduseAdminAreaForUpdate(
    service: EntityAdminAreaService,
    body: Record<string, unknown>,
    geometry: unknown,
