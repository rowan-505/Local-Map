...
} from "./landuse-admin-area-write.js";
...
describe("applyLanduseAdminAreaForUpdate", () => {
...
describe("applyLanduseAdminAreaForCreate", () => {
    it("infers township when admin_area_id is omitted", async () => {
        const body: Record<string, unknown> = {};
        await applyLanduseAdminAreaForCreate(makeService(), body, polygonGeometry, testUser);
