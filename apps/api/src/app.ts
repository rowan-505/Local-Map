...
import searchIndexHealthAdminRoutes from "./modules/search/search-index-health-admin.routes.js";
...
export async function buildApp() {
    ...
    await app.register(searchAnalyticsAdminRoutes);
    await app.register(searchIndexHealthAdminRoutes);
