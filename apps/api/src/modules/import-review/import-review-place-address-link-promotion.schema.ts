...
export const postImportReviewPlaceAddressLinkPromotionBodySchema = z
    .object({
...
export type PostImportReviewPlaceAddressLinkPromotionBody = z.infer<
    typeof postImportReviewPlaceAddressLinkPromotionBodySchema
>;
