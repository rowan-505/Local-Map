...
export const postImportReviewPlaceValidateBodySchema = z
    .object({
...
export type PostImportReviewPlaceValidateBody = z.infer<
    typeof postImportReviewPlaceValidateBodySchema
>;
