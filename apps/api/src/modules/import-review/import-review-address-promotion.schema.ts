...
export const postImportReviewAddressPromotionBodySchema = z
    .object({
...
export type PostImportReviewAddressPromotionBody = z.infer<
    typeof postImportReviewAddressPromotionBodySchema
>;
