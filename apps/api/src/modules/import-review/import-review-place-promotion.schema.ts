...
export const postImportReviewPlacePromotionBodySchema = z
    .object({
...
export type PostImportReviewPlacePromotionBody = z.infer<
    typeof postImportReviewPlacePromotionBodySchema
>;
