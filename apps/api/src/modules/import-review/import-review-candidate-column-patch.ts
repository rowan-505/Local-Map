...
const STATIC_WRITABLE_COLUMNS_BY_TABLE: Record<string, ReadonlySet<string>> = {
    ...
    "import_review.bus_stop_candidates": new Set([
        "name_mm",
        "name_en",
        "stop_code",
        "admin_area_id",
    ...
    "import_review.bus_route_candidates": new Set([
        "name_mm",
        "name_en",
        "public_name",
        "route_code",
    ...
    "import_review.bus_route_variant_candidates": new Set([
        "route_id",
        "route_code",
        "variant_code",
        "direction_name",
    ...
    "import_review.bus_route_stop_candidates": new Set([
        "route_variant_id",
        "stop_id",
        "stop_sequence",
