...
const streetRowSchema = {
    ...
    properties: {
        ...
        travel_direction: {
            type: "string",
            enum: ["forward", "reverse", "reversible", "alternating", "unknown"],
            nullable: true,
        },
        is_oneway: {
            type: "boolean",
            deprecated: true,
            description: "Compatibility value derived from travel_direction",
        },
        bridge: { type: "boolean" },
        tunnel: { type: "boolean" },
        ...
        edit_status: {
            type: "string",
            deprecated: true,
            description: "Legacy per-street lifecycle value; not authoritative",
        },
        routing_status: {
            type: "string",
            deprecated: true,
            description: "Legacy per-street build value; use routing build/job state",
        },
        ...
        is_verified: {
            type: "boolean",
            deprecated: true,
            description: "Compatibility value derived from verification_status",
        },
...
const createStreetBodyOpenApi = {
    ...
    properties: {
        ...
        travel_direction: {
            type: "string",
            enum: ["both", "forward", "reverse", "reversible", "alternating", "unknown"],
            nullable: true,
        },
        travelDirection: {
            type: "string",
        ...
        is_oneway: { type: "boolean", description: "Deprecated; maps true to forward and false to bidirectional" },
        surface: { type: "string", nullable: true },
        admin_area_id: { type: "string", nullable: true },
...
const updateStreetBodyOpenApi = {
    ...
    properties: {
        ...
        is_oneway: { type: "boolean", description: "Deprecated" },
        isOneway: { type: "boolean", description: "Deprecated" },
        surface: { type: "string", nullable: true },
        admin_area_id: { type: "string", nullable: true },
        adminAreaId: { type: "string", nullable: true },
