...
export const CORE_REVIEW_OVERVIEW_MODULES: readonly CoreReviewOverviewModule[] = [
    {
        ...
        sourceTable: "core.core_buildings",
        sourceSchema: "core",
        access: "editable",
    },
    {
    ...
    },
    {
        segment: "land-areas",
        title: "Land areas",
        description: "Land area polygons from the core schema (urban, farmland, landcover, wetlands).",
        href: coreReviewPath("land-areas"),
        sourceTable: "core.core_land_areas",
        sourceSchema: "core",
        access: "read-only",
    },
    {
        ...
        sourceTable: "core.core_water_lines",
        sourceSchema: "core",
        access: "read-only",
    },
    {
        ...
        sourceTable: "core.core_water_polygons",
        sourceSchema: "core",
        access: "read-only",
    },
    {
