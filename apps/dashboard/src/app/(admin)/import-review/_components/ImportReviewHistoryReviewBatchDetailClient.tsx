            ...
            <div className="mx-auto max-w-7xl space-y-6">
                ...
                {data ? (
                    <>
                        ...
                        <section>
                            <h2 className="text-lg font-semibold text-gray-900">Publish batches</h2>
                            {data.publish_batch_summaries.length === 0 ? (
                                <p className="mt-2 text-sm text-gray-600">No publish batches linked yet.</p>
                            ) : (
                                <ul className="mt-3 space-y-2">
                                    {data.publish_batch_summaries.map((pb) => (
                                        <li key={pb.id}>
                                            <Link
                                            ...
                                            <span className="ml-2 text-xs text-gray-500">
                                                {pb.status} · {pb.success_count}/{pb.total_item_count} success
                                            </span>
                                        </li>
                                    ))}
                                </ul>
