...
const EDIT_CONFIG_EXPORTS = [
    ...
    { file: "landuse.ts", exportName: "LANDUSE_ENTITY_CONFIG" },
    { file: "extendedEntities.tsx", exportName: "BUS_STOPS_ENTITY_CONFIG" },
    { file: "extendedEntities.tsx", exportName: "BUS_ROUTES_ENTITY_CONFIG" },
    { file: "extendedEntities.tsx", exportName: "BUS_ROUTE_VARIANTS_ENTITY_CONFIG" },
