...
export function useImportReviewBulkActions(args: {
    ...
    return {
        ...
        bulkPreviewApprove,
        bulkApproveSelected,
        bulkRejectSelected: () => bulkDecisionSelected("keep_existing", "Keep existing for"),
        bulkNeedsMoreReviewSelected: () =>
            bulkDecisionSelected("needs_more_review", "Mark needs more review for"),
        bulkIgnoreSelected: () => bulkDecisionSelected("ignore_import", "Ignore imported for"),
        bulkKeepExistingSelected: () => bulkDecisionSelected("keep_existing", "Keep existing for"),
