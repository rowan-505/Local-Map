...
**Status:** Local pipeline policy (implemented). Production safe loaders for important/named **buildings**, **landuse**, and **water** exist for pilot batches only — national / full-city loads remain **disabled**.  
...
**Pilot reports:** `tools/data-pipeline/import-work/reports/*_yangon_safe_loader_2026-07-23.md` (water polygons: Kyauktan sample).
...
|----------------|-------------|---------------|
| `safe_new` / `safe_update` | yes (when loaders exist) | no |
