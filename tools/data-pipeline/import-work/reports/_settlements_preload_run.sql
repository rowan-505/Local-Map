...
-- Caller must replace /Users/nyihtet/Documents/Projects/Core-Map/tools/data-pipeline/import-work/reports/_kyauktan_safe_settlements.csv before running, or use the shell wrapper.
BEGIN;
...
\copy kyauktan_safe_export FROM '/Users/nyihtet/Documents/Projects/Core-Map/tools/data-pipeline/import-work/reports/_kyauktan_safe_settlements.csv' WITH (FORMAT csv, HEADER true)
...
INSERT INTO import_work.import_batches (
    ...
    'not_started',
    'Kyauktan settlements rural pilot safe load'
)
