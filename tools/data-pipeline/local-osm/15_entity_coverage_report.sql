...
VALUES
    ...
    ( 4, 'landuse', 'staging_landuse_candidates', 'land_area_candidates',
      'core.core_land_areas',
      NULL,
      'MultiPolygon', 'geom',
      'ref.ref_land_area_classes via land_area_class_id (Stage 05 normalize)',
      'normalize-wired', 'P2', 'low'),

    ( 5, 'water_lines', 'staging_water_line_candidates', 'water_line_candidates',
      'core.core_water_lines',
      NULL,
      'MultiLineString', 'geom',
      'ref.ref_water_classes via water_class_id (Stage 05 normalize)',
      'normalize-wired', 'P2', 'low'),
    ...
    ( 65, 'coastlines', 'staging_coastline_candidates', NULL,
      'core.core_coastlines',
      NULL,
      'LineString/MultiLineString', 'geom',
      'natural=coastline only (no per-feature Core class FK)',
      'staging-only', 'P2', 'low'),
