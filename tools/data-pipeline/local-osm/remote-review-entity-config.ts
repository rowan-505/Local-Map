...
export const ENTITY_FAMILY_UPLOAD_CONFIG: Record<EntityFamilySlug, EntityFamilyUploadConfig> = {
  buildings: {
    ...
    matchedCoreTable: 'core_buildings',
  ...
  landuse: {
    ...
    matchedCoreTable: 'core_land_areas',
    ...
    optionalImportColumns: ['name', 'geom', 'centroid', 'land_area_class_id', 'class_code'],
    childRelations: [],
  },
  water_lines: {
    ...
    matchedCoreTable: 'core_water_lines',
    ...
    optionalImportColumns: ['name', 'geom', 'water_class_id', 'class_code'],
    childRelations: [],
  },
  water_polygons: {
    ...
    matchedCoreTable: 'core_water_polygons',
    ...
    optionalImportColumns: ['name', 'geom', 'centroid', 'water_class_id', 'class_code'],
    childRelations: [],
  },
  addresses: {
