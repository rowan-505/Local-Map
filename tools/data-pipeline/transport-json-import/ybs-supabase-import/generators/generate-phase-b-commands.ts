...
const CLEANUP_SCRIPT =
    "tools/data-pipeline/transport-json-import/ybs-supabase-import/cleanup/cleanup-test-ybs-route.ts";
const IMPORT_SCRIPT =
    "tools/data-pipeline/transport-json-import/ybs-supabase-import/import/run-ybs-import-workflow.ts";
const VALIDATE_SCRIPT =
    "tools/data-pipeline/transport-json-import/ybs-supabase-import/validate/validate-imported-ybs.ts";
