...
npx tsx tools/data-pipeline/transport-json-import/ybs-supabase-import/cleanup/report-legacy-cleanup-candidates.ts \\
  --report-dir ${rel}
...
npx tsx tools/data-pipeline/transport-json-import/ybs-supabase-import/cleanup/cleanup-orphan-legacy-stops.ts \\
  --report-dir ${rel} \\
  --dry-run
\`\`\`
