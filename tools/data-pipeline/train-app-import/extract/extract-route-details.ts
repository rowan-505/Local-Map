...
console.error(
    [
        "ADB route-detail extraction is not supported for YRS Move (Flutter + InAppWebView).",
        ...
        "",
        "Legacy ADB code (for reference only): extract/legacy-adb/extract-route-details.ts",
    ].join("\n"),
);
