-- =============================================================================
-- verify_roads_admin_area_id.sql
...
--
-- Companion to 05_backfill_roads_admin_area.sql. Run any time (read-only):
...
BEGIN
    IF to_regprocedure('core.admin_area_row_matches_target(bigint,text,text,text)') IS NULL THEN
        RAISE WARNING 'admin_area_row_matches_target missing — run stage 03 for full checks';
    END IF;
END $$;
